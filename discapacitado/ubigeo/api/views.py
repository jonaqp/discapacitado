...
from phr.ubigeo.api.serializers import DetalleUbigeoContinenteSerializer, DetalleUbigeoDepartamentoSerializer, \
    DetalleUbigeoDistritoSerializer, DetalleUbigeoPaisSerializer, DetalleUbigeoProvinciaSerializer, \
...
class ListaUbigeoDepartamentoAPI(ListAPIView):
    ...
    def provider_inei(self):
        ...
        return UbigeoDepartamento.objects.filter(continente=continente, pais=pais)
...
class ListaUbigeoProvinciaAPI(ListAPIView):
    ...
    def provider_inei(self):
        ...
        return UbigeoProvincia.objects.filter(continente=continente, pais=pais, departamento=departamento)
