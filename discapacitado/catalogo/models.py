...
class CatalogoCIE(models.Model):
    ...
    desc_ciex = models.CharField(max_length=200, null=False, blank=False)
    ...
    def __str__(self):
        return self.desc_ciex


class CatalogoProcedimiento(models.Model):
    codigo_grupo = models.CharField(max_length=10)
    nombre_grupo = models.CharField(max_length=200, null=False, blank=False)
